export default function Terms() {
  return (
    <main className="prose">
      ...
      <p>
        Intersect Software Ltd. operates <strong>Web Reactionz</strong> (“
        <strong>Company</strong>
        ”, “<strong>we</strong>”, “<strong>our</strong>”, “<strong>us</strong>
        ”) at <a href="https://webreactionz.com/">https://webreactionz.com</a>.
        We are registered in England &amp; Wales under company number 14955283
        with registered office address 82A, James Carter Road, Mildenhall,
      ...
      <p>
        ...
        located at{" "}
        <a href="https://webreactionz.com">https://webreactionz.com</a> and our
        related products (together or individually “Service”).
      </p>
      <p>
        ...
        use of our Service. Please read it{" "}
        <a href="https://webreactionz.com/privacy">here</a>.
      </p>
      <p>
      ...
      <p>
        ...
        may not use the Service, but please let us know by{" "}
        <a href="mailto:support@webreactionz.com">emailing us</a> so we can try
      ...
      <p>
        ...
        <a href="mailto:support@webreactionz.com">emailing us</a>.
      </p>
      <h4>
        3. <strong>Fees &amp; Purchases</strong>
      </h4>
      <p>
      ...
      <p>
        Web Reactionz, in its sole discretion and at any time, may modify fees
        for the product(s).
      </p>
      <p>
        You are responsible for any mobile network carrier data plans, Internet
        fees and any other fees or taxes associated with your use of Service.
      </p>
      <h4>
      ...
      <h4>
        5. <strong>Prohibited Uses</strong>
      </h4>
      <p>
      ...
      <ol>
        <li>
          Use Service alongside or for any of the following activities: illegal
          content, products, and services; drugs; adult content, products, and
          services; weapons and dangerous materials; gambling.
        </li>
        <li>
        ...
        <li>
          ...
          access or use Service for any purpose, including monitoring or copying
          any of the material on Service, or automating the creation of
          reactions/votes on websites via Service.
        </li>
        <li>
        ...
        <li>
          Attempt to circumvent limits or restrictions placed on an account.
        </li>
        <li>Create or use more than one account.</li>
        <li>
      ...
      <p>
        Please <a href="mailto:support@webreactionz.com">contact us</a> first in
        any cases of doubt regarding your intended use of the Service.
      </p>
      <h4>
        6. <strong>Age restriction</strong>
      </h4>
      <p>
      ...
      <h4>
        8. <strong>Intellectual Property</strong>
      </h4>
      <p>
      ...
      <p>
        You may provide us directly at support@webreactionz.com with information
      ...
      <h4>
        10. <strong>Links To Other Web Sites</strong>
      </h4>
      <p>
        Our Service may contain links to third party web sites or services that
        are not owned or controlled by Web Reactionz.
      </p>
      <p>
        Web Reactionz has no control over, and assumes no responsibility for the
        content, privacy policies, or practices of any third party web sites or
        services. We do not warrant the offerings of any of these
        entities/individuals or their websites.
      </p>
      <p>
        Furthermore, whilst we will make our best efforts to keep improving the
        Service, we may remove any features at our discretion at any time.
      </p>
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT WEB REACTIONZ SHALL NOT BE RESPONSIBLE OR
      ...
      <p>
        ...
        OF ANY THIRD PARTY WEB SITES OR SERVICES THAT YOU VISIT OR CHOOSE TO
        USE.
      </p>
      <h4>
        11. <strong>Disclaimer Of Warranty</strong>
      </h4>
      <p>
      ...
      <p>
        ...
        Service or delete your account by emailing us.
      </p>
      <p>
      ...
      <p>
        ...
        of the United Kingdom, which governing law applies to agreement without
      ...
      <h4>
        15. <strong>Changes To Service</strong>
      </h4>
      <p>
      ...
      <h4>
        16. <strong>Amendments To Terms</strong>
      </h4>
      <p>
      ...
      <h4>
        17. <strong>Waiver And Severability</strong>
      </h4>
      <p>
      ...
      <h4>
        18. <strong>Acknowledgement</strong>
      </h4>
      <p>
      ...
      <p>
        ...
        <a href="mailto:support@webreactionz.com">by email</a>.
      </p>
    </main>
  );
}
