...
ARG BUILD_PAPERCUPS_TOKEN
ENV NEXT_PUBLIC_PAPERCUPS_TOKEN $BUILD_PAPERCUPS_TOKEN
ARG BUILD_PAPERCUPS_INBOX
ENV NEXT_PUBLIC_PAPERCUPS_INBOX $BUILD_PAPERCUPS_INBOX
ARG BUILD_PAPERCUPS_URL
ENV NEXT_PUBLIC_PAPERCUPS_URL $BUILD_PAPERCUPS_URL
